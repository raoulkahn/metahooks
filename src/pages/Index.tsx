...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-background/80 px-4">
      ...
      <div className="max-w-4xl mx-auto pt-4 pb-24 animate-fade-up">
        ...
        <div className="glass rounded-2xl p-6 space-y-6">
          ...
          <div className="space-y-3">
            <Textarea
              ...
              className="min-h-[120px] text-lg p-4 resize-none bg-background/50"
              value={content}
          ...
          <div className="flex justify-center">
            <Button
              className="py-2 sm:py-4 text-base sm:text-lg font-medium px-8 sm:px-12"
